...
export default function App() {
  ...
  return <main className="min-h-dvh bg-surface">
    ...
    <header className="flex min-h-[72px] items-center justify-between gap-6 border-b border-line bg-surface/95 px-[clamp(18px,3vw,40px)] py-3 max-[560px]:min-h-16 max-[560px]:px-4">
    ...
    <div className="grid h-[calc(100dvh-72px)] min-h-0 grid-cols-[minmax(0,1fr)_420px] max-[900px]:h-auto max-[900px]:grid-cols-1">
      <section className="relative min-h-0 min-w-0 overflow-hidden border-r border-line bg-surface max-[900px]:min-h-[58dvh] max-[900px]:border-r-0 max-[900px]:border-b" aria-labelledby="scene-title">
        ...
        <div className="pointer-events-none absolute top-[30px] left-[clamp(20px,3vw,42px)] z-10"><span className="mb-2 block font-mono text-[0.68rem] font-bold tracking-[0.14em] text-accent uppercase">3D viewport</span><h2 className="text-[clamp(1.6rem,3vw,2.25rem)] font-medium tracking-[-0.04em]" id="scene-title">Plane & cube</h2></div>
