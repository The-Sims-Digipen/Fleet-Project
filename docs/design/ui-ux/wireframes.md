...
## WF02 — planning workspace (FL, TR, FI, EM; T006, T020, T029)
...
| [ ] A   ICE -> 2027    |                               | Transition year    |
| [ ] B   ICE -> 2028    | Selected object highlighted   | Range / operation  |
| [Add] [Edit] [Remove]  |                               | [Apply to selected]|
| Selected: 2           |                               | Charging settings  |
+-----------------------+-------------------------------+--------------------+
| Year: [2026 <------o--------------------> 2029]  2027 v                  |
| ICE 1 · EV 1 · Demand 7 kW / Limit 6 kW · OVERLOAD: 1 kW                 |
+------------------------------------------------------------------------+
| TCO | CAPEX | Annual OPEX | Savings vs ICE | Emissions | Payback          |
...
## WF03 — depot authoring (DE, FL-05; T047, T051–T057)
...
## WF04 — comparison (CO, VI-05; T039, T042, T043)

```text
Compare · Same project fleet and analysis · ICE baseline TCO: ...
Shared year: 2027 v                         [Return to Plan]
+-----------------------------------+------------------------------------+
| Plan A v                 [Edit A] | Plan B v                  [Edit B] |
| Independent depot scene          | Independent depot scene            |
| ICE/EV counts · demand/limit     | ICE/EV counts · demand/limit       |
...
## WF05 — saving and conflict recovery (SC-04; T025, T026, T058)
